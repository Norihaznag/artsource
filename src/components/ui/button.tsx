...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-primary-500 text-secondary-900 hover:bg-primary-400 focus:ring-primary-500 shadow-lg hover:shadow-xl',
      ...
      ghost: 'text-secondary-900 hover:bg-secondary-100 focus:ring-secondary-500',
      whatsapp: 'bg-[#25D366] text-white hover:bg-[#20BD5A] focus:ring-[#25D366] shadow-lg hover:shadow-xl',
    };
