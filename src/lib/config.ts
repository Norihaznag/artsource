...
export const defaultCategories: import('@/types/database').Category[] = [
  {
    id: '1',
...
export const defaultTestimonials: import('@/types/database').Testimonial[] = [
  {
    id: '1',
...
export const defaultFAQs: import('@/types/database').FAQ[] = [
  {
    id: '1',
...
export const defaultProducts: import('@/types/database').Product[] = [
  {
    id: '1',
    ...
    pricing_text_fr: null,
    pricing_text_ar: null,
    category_id: '1',
    starting_price: 150,
